...
@Component({
  selector: 'period-timestamp',
  templateUrl: './period-timestamp.component.html',
  styleUrls: ['./period-timestamp.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PeriodTimestampComponent implements OnInit {
