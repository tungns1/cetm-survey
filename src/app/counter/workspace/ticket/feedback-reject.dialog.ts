...
export class FeedbackRejectlDialog {
    ...
    textReason: string = '';
    reasons = [
        { id: 0, name: this.translateService.translate('Customer left') },
        { id: 1, name: this.translateService.translate('Customer denied giving feedback') },
        { id: 2, name: this.translateService.translate('Other reason') }
    ];
    checkedReason;
